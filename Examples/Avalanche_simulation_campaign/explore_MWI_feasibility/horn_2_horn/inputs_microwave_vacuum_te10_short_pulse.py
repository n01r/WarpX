...
t_sim_override = 15e-9      # e.g. 1.5e-9 for 1.5 ns
...
field_snapshot_dt = 0.1e-9      # e.g. 0.1e-9 for every 0.1 ns
...
# Receiving-plane full 3D diagnostic (every recv_plane_period steps)
...
# FieldProbe plane diagnostic on the receiving plane
recv_plane_probe = picmi.ReducedDiagnostic(
    ...
    detector_radius=horn_half_width_x * np.sqrt(2),  # half-edge = a/2
